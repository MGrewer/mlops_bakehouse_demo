...
PREDICTIONS_TABLE = f"{CATALOG}.{SCHEMA_PROD}.bakehouse_demand_predictions"
...
with mlflow.start_run(run_name="batch_inference_drifted") as run:
...
print("Demo state reset — ready to re-run from notebook 01")
